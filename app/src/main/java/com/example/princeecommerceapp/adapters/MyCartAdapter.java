...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolader> {
    ...
    @NonNull
    @Override
    public MyCartAdapter.ViewHolader onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolader(LayoutInflater.from(parent.getContext()).inflate(R.layout.my_cart_item,parent,false));
    }
