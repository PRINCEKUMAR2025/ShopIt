...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolader> {
    ...
    @NonNull
    @Override
    public AddressAdapter.ViewHolader onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolader(LayoutInflater.from(parent.getContext()).inflate(R.layout.address_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull AddressAdapter.ViewHolader holder, int position) {
